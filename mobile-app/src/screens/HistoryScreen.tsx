...
// Diese Zeile importiert die typisierten Eigenschaften des Verlaufsbildschirms.
import type { HistoryScreenProperties } from '../types/applicationNavigation';


// Diese Funktion rendert den Verlaufsbildschirm.
export function HistoryScreen({ navigation }: HistoryScreenProperties): React.JSX.Element {
  ...
  // Diese Zeile gibt die gesamte Benutzeroberfläche des Verlaufsbildschirms zurück.
  return (
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.headerSection}>
          ...
          <Text style={styles.screenDescription}>
            This placeholder screen confirms that navigation from the HomeScreen and the DetectionResultScreen works.
          </Text>
        </View>

        {/* Diese Zeile zeigt einen ersten Platzhalter-Eintrag an. */}
        <InformationCard
          // Diese Zeile setzt den Titel der Karte.
          title="History placeholder entry"
          // Diese Zeile setzt die Beschreibung der Karte.
          description="Real local storage entries will be added in a later ticket."
        />
