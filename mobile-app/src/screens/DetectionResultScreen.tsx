      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.headerSection}>
          ...
          <Text style={styles.screenDescription}>
            This screen receives typed result data without crashing and renders the transferred values.
          </Text>
        </View>
        ...
        {/* Diese Zeile zeigt die Bildgröße an. */}
        <InformationCard
          // Diese Zeile setzt den Titel der Karte.
        ...
        {/* Diese Zeile zeigt den Abschnitt der Erkennungen an. */}
        <Text style={styles.sectionTitle}>Received detections</Text>

        {/* Diese Zeile rendert für jede Erkennung eine Informationskarte. */}
        {detections.map((trafficSignDetection) => (
          // Diese Zeile rendert eine Informationskarte pro Erkennung.
          <InformationCard
            ...
            // Diese Zeile setzt die Beschreibung der Karte.
            description={trafficSignDetection.meaning}
          />
        ))}
...
const styles = StyleSheet.create({
  ...
  sectionTitle: {
    // Diese Zeile setzt die Schriftgröße des Abschnittstitels.
    fontSize: 20,
    // Diese Zeile macht den Abschnittstitel fett.
    fontWeight: '700',
    // Diese Zeile setzt die Haupttextfarbe.
    color: colorPalette.textPrimary,
