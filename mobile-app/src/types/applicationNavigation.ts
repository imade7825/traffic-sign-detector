...
export type ApplicationStackParameterList = {
  ...
  ImageReviewScreen: // Diese Zeile erlaubt ein Parameterobjekt für den Screen.
  | {
        // Diese Zeile definiert die Bildadresse als optionalen Wert.
        imageUri?: string;
      }
    // Diese Zeile erlaubt auch fehlende Parameter, damit der Screen nicht abstürzt.
    | undefined;
...
export type HomeScreenProperties = NativeStackScreenProps<
  ApplicationStackParameterList,
  "HomeScreen"
>;

// Diese Typdefinition beschreibt die Eigenschaften des Bildprüfungsbildschirms.
export type ImageReviewScreenProperties = NativeStackScreenProps<
  ApplicationStackParameterList,
  "ImageReviewScreen"
>;

// Diese Typdefinition beschreibt die Eigenschaften des Ergebnisbildschirms.
export type DetectionResultScreenProperties = NativeStackScreenProps<
  ApplicationStackParameterList,
  "DetectionResultScreen"
>;

// Diese Typdefinition beschreibt die Eigenschaften des Verlaufsbildschirms.
export type HistoryScreenProperties = NativeStackScreenProps<
  ApplicationStackParameterList,
  "HistoryScreen"
>;
